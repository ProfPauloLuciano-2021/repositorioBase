...
<body>
	...
	<main>
		...
		<fieldset>
		<legend>Informações do Morador</legend>
		
		<label for="">Bloco/Apt:</label>
		<select name="Bloco/Apt">
		...
		<label for="">Grau Parentesco em relação ao Proprietário(a):</label>
		...
		<input id="" type="checkbox" name="enderecoExterno"  /><label for="">Ativar Endereço Externo</label>
		<fieldset>
		<legend>Endereço Externo</legend>
